    ...
    public Map<String, Object> queryLastYear(Client client) {
        ...
        if (resultJson.has("errorMsg")) {
            ...
            if ("success".equals(msg)) {
                ...
                try {
                    data = new JSONObject(resultJson.getString("data"));
                ...
                synchronized (InsuranceService.class) {
                    ...
                    if (exist == null) {
                        ...
                        client.setQuoteStateCode(INSURANCE.QUOTESTATE_NOTQUOTE.getCode());
                        client.setQuoteState(INSURANCE.QUOTESTATE_NOTQUOTE.getName());
