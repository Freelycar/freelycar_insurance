...
public class WechatConfig {
    ...
    public static final String APP_ID = "wx1394f2d5a7311394";
    public static final String MCH_ID = "1493352962";

    //public static final String MCH_ID = "1234616002";   //商户号，微信商户平台里面获取  原小易爱车公众号
    public static final String APP_SECRET = "7a22adabbbd8b41d101f9604a42a5292";
...
//	private static Logger log = Logger.getLogger(WechatConfig.class);
    ...
    public static JSONObject getAccessToken(String code) {
        ...
        JSONObject obj = HttpClientUtil.httpGet(tokenUrl);
    ...
    public static JSONObject getWXUserInfo(String accessToken, String openId) {
        ...
        JSONObject obj = HttpClientUtil.httpGet(wxUserInfoUrl);
        return obj;
    }
    ...
    public static JSONObject getJsApiTicketByWX() {
        ...
        JSONObject jsonObject = HttpClientUtil.httpGet(jsAPITicktUrl);
